...
export const CatalogSettingsPage: React.FC = () => {
  ...
  const filteredGarments = useMemo(() => {
    const list = garments.filter((g) => {
      ...
      const matchesSearch =
        ...
        (CATEGORY_LABELS[g.category] || g.category).toLowerCase().includes(searchQuery.toLowerCase());
  ...
  const handleExportCSV = () => {
    ...
    link.setAttribute('download', `garment-catalog-${(CATEGORY_LABELS[activeCategory] || activeCategory).toLowerCase()}.csv`);
  ...
  const getBasePriceFor = useCallback(
    (garmentId: string): number | null => {
      const garmentPrices = pricingData
        .filter(
          (p: any) =>
            p.garmentCatalogId === garmentId && p.price !== undefined && p.price !== null,
        )
        .map((p: any) => p.price);
    ...
    <div className="h-screen flex flex-col overflow-hidden bg-slate-100 font-sans">
                  ...
                  <CatalogNavFilter
                    ...
                    rightToolbarContent={
                      <>
                        ...
                        >
                          <span style={{ color: '#64748b', fontWeight: 500, fontSize: '13px' }}>Sort:</span>
                          <select
                            value={sortOrder}
                          ...
                          return (
                            <div
                              ...
                              style={{
                                ...
                                border: garment.isActive ? '1px solid #e2e8f0' : '1px solid #cbd5e1',
                                borderRadius: '3px',
                                padding: '12px 10px',
                                display: 'flex',
                                flexDirection: 'column',
                            ...
                            <div
                              ...
                              style={{ width: '100%', borderTop: '1px solid #f1f5f9', margin: '8px 0' }}
                            ></div>
                            ...
                            {canManage && (
                              <button
                                ...
                                title="Edit garment"
                              >
                                <Edit2 size={12} className="text-slate-400 group-hover:text-blue-600" />
                                <span>Edit</span>
                              </button>
                            )}
                          </div>
                  ...
                  {filteredGarments.length > 0 && (
                    ...
                    >
                      <span className="text-slate-500">
                        Showing{' '}
                        <strong className="text-slate-800 font-semibold" style={{ color: '#1e293b', fontWeight: 600 }}>
                            ...
                            (pageNum) => (
                              <button
                                ...
                                style={{
                                  ...
                                  justifyContent: 'center',
                                  cursor: 'pointer',
                                  border: currentPage === pageNum ? '1px solid #bfdbfe' : '1px solid #e2e8f0',
                  ...
                  >
                      ...
                      rightToolbarContent={
                        ...
                        >
                          ...
                          <div className="flex items-center gap-2 text-xs font-semibold text-slate-600 px-1">
                            ...
                            <span>
                              {pricingConfiguredCount}/{pricingFilteredGarments.length} configured for{' '}
                              {currentPricingService?.name || 'Selected Service'}
                            </span>
                          </div>
                    ...
                    {priceSaveSuccess && (
                      <div className="p-3 bg-emerald-50 border border-emerald-200 text-emerald-800 text-xs font-semibold rounded-lg flex items-center gap-2 shadow-2xs">
                        <Check size={16} className="text-emerald-600 shrink-0" /> {priceSaveSuccess}
                      </div>
                    )}
                    {priceSaveError && (
                          ...
                          <table className="w-full text-left text-sm border-collapse">
                            ...
                            <tbody className="divide-y divide-slate-100">
                              {pricingFilteredGarments.map((garment, idx) => {
                                ...
                                const allConfigured =
                                  configuredCountForGarment === totalServices && totalServices > 0;
      ...
      {createModalOpen && (
        <div className="fixed inset-0 bg-slate-900/40 backdrop-blur-xs flex items-center justify-center p-4 z-50 overflow-y-auto">
          ...
          >
            <form onSubmit={handleCreate} className="flex flex-col m-0 p-0 w-full h-full box-border overflow-hidden">
              {/* Modal Header (Pinned) */}
              <div
              ...
              >
                ...
                <div className="w-full">
                  ...
                  <div className="flex flex-col w-full" style={{ gap: '16px' }}>
                    ...
                    <div className="w-full">
                      <label className="block text-[10px] font-bold text-slate-700 tracking-wider uppercase mb-1.5">
                        SECTION / NOTES <span className="text-slate-400 font-normal lowercase">(optional)</span>
                      </label>
                      <input
                        type="text"
